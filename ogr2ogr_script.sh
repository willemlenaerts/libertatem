...
SOURCEDIR= "./geodata/ElectionHistory/input/MapData/NaturalEarthData/ADM0/geojson/country/"
OUTPUTDIR= "./geodata/ElectionHistory/input/MapData/NaturalEarthData/ADM0/topojson/country/"
