    ...
    for j in range(len(bet_choice)):
        ...
        for competition in competitions:
            for season in seasons:
                ...
                output["Pi_bets"].append(len(games_i_j[(games_i_j.Competition == competition) & (games_i_j.Season == season) & (games_i_j.Pi_profit.notnull())].sort("Date")))
                output["Pi_stake"].append(len(games_i_j[(games_i_j.Competition == competition) & (games_i_j.Season == season) & (games_i_j.Pi_profit.notnull())].sort("Date")))
                output["Pi_profit"].append(games_i_j[(games_i_j.Competition == competition) & (games_i_j.Season == season) & (games_i_j.Pi_profit.notnull())].sort("Date").Pi_profit.sum())
